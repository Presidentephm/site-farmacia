...
PONTO = [  # (funcionario, tipo, qtde, observacao)
 ...
 ("VALÉRIA", "NOT",  16, "2 madrugadas de jornada normal de 8 horas com intervalo (2 × 8 = 16 h), com folga normal no dia seguinte — cabe só o adicional noturno."),
 ("AGNOR",   "NOT",  24, "3 madrugadas de jornada normal de 8 horas com intervalo (3 × 8 = 24 h), com folga normal — cabe só o adicional noturno."),
...
blocos = [
 ...
 ("P", "VALÉRIA e AGNOR: as madrugadas entraram como 8 horas cada (jornada normal com intervalo). Se só parte dessas horas ficou entre 22h e 5h, ajustar a quantidade na aba PONTO AGO.26."),
